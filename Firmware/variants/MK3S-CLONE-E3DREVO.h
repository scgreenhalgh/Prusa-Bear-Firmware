...
// Printer name
#define CUSTOM_MENDEL_NAME "Eugene i3 MK3S+R"
...
#define  DEFAULT_Kp 40.98
#define  DEFAULT_Ki 7.99
...
#define FANCHECK_AUTO_PRINT_FAN_THRS 50 //[RPS] - Used during selftest to identify swapped fans automatically
#define FANCHECK_AUTO_FAIL_THRS 10 //[RPS] - Used during selftest to identify a faulty fan
